...
class Operation(object):
    ...
    def __init__(self):
        ...
        root=os.getcwd()
        self.config.read(root+"\\Config_idcm.ini", encoding='utf-8')
        self.xml = self.config.get("IPD_COMMUNICATION_XML", "NAME")
        self.cluster = self.config.get("CAN_CLUSTER","NAME")
        self.sysvar_name = self.config.get("SysvarFileName","NAME")
        self.capl_name = self.config.get("CAPLFileName","NAME")
        self.Frame_Pdu = {}
        self.Pdu_Signal = {}
        self.Container_Pdu = {}
        self.Data_Type = {}
    ...
    def run(self):
        ...
        self.generate_sysvar("ECU_Default_Value_SysVar_ARXML_IDCM")
        self.generate_file("ECU_Default_Value_CAPL_ARXML_IDCM")
