...
static unsigned int sNetworkStreamNoElements  = 164;                    // e.g. 7500 uints @ 4 bytes each
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    unsigned int *magicNo1         = ssGetOutputPortSignal( S, 13 );
		...
		*magicNo1 =3;}
        ...
        for ( i = 1; i < 12; i += 2 )
        {
            ...
            switch ( i )
            {
                ...
                case 3: // get the road mark
                    *tgtScalar = rdbMapperGetElementsOfType( tgtVec, maxSize, RDB_PKG_ID_ROADMARK );
                    break;
                    
                case 5: // get the lane info
                    *tgtScalar = rdbMapperGetElementsOfType( ownID, tgtVec, maxSize, RDB_PKG_ID_LANE_INFO );
                    break;
