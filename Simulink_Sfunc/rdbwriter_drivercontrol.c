...
#define S_FUNCTION_NAME rdbwriter_drivercontrol
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    *pOutMsgSize = 0;
    ...
    rdbMsg->hdr.dataSize   = 3 * sizeof( RDB_MSG_ENTRY_HDR_t ) + sizeof( RDB_DRIVER_CTRL_t ) ;
    ...
    rdbMsg->entrydrivercontrol.flags       = 0;//TBD
