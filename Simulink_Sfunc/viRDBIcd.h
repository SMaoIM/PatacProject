...
#define RDB_VERSION       0x0119       /**< upper byte = major, lower byte = minor  @version 0x0114 */
/** @} */
...
#define RDB_COORD_TYPE_TRACK           10  /**< lane co-ordinate (x=s, y=t )             @version 0x0119 */
/** @} */
...
typedef struct
{
    ...
    int8_t      laneId;                  /**< id of lane                                                        @unit _                                    @version 0x0100 */
    ...
    uint32_t    roadId;                   /**< id of road                                                            @unit _                                    @version 0x0100 */
...
typedef struct
{
    ...
    uint32_t            flags;                      /**< flags for state monitoring etc.                               @unit RDB_MOTION_SYSTEM_FLAG             @version 0x0116 */
...
typedef struct
{
    ...
    uint16_t cfgFlags;         /**< configuration flags                                          @unit @link RDB_OBJECT_CFG_FLAG @endlink   @version 0x0119 */
    int16_t  cfgModelId;       /**< model ID                                                     @unit _                                    @version 0x0119 */
    uint16_t visMask;          /**< visibility mask                                              @unit @link RDB_OBJECT_VIS_FLAG @endlink   @version 0x0119 */
    uint8_t  active;           /**< set player to active                                         @unit [0,1]                                @version 0x0119 */
    ...
    double   initialRoadS;     /**< initial road position (negative if no road is available)     @unit m                                    @version 0x0119 */
    float    initialRoadT;     /**< initial lateral road position                                @unit m                                    @version 0x0119 */
    float    targetRoadT;      /**< target lateral road position                                 @unit m                                    @version 0x0119 */
    ...
    uint32_t validityFlags;    /**< flags which of the above inputs are valid                    @unit tbd.                                 @version 0x0119 */
